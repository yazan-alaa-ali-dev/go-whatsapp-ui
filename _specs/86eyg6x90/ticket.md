---
ticket: 86eyg6x90         # canonical id/slug; matches ^[A-Za-z0-9][A-Za-z0-9._-]*$
...
created_at: 2026-08-02   # YYYY-MM-DD
updated_at: 2026-08-03   # YYYY-MM-DD (bumped on every state change)
links:                   # OPTIONAL delivery links — metadata only, NOT workflow state
  clickup: https://app.clickup.com/t/86eyg6x90
  github: https://github.com/yazan-alaa-ali-dev/whats-app-server/pull/31   # PR URL (set by /publish-pr after publishing; never drives state)
---

# Ticket Record — 86eyg6x90
